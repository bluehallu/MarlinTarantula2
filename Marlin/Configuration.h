...
#define CUSTOM_MACHINE_NAME "TRAM REQS NO MESH!!"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -5, -40, -1.2 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 10, 50, 10, 40 } // (mm) Left, Front, Right, Back insets
